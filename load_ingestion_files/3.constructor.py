...
constructor_final_df.write.mode("append").format("parquet").saveAsTable("f1_processed_new.constructor_tb")

# COMMAND ----------

# MAGIC %sql
# MAGIC select file_date, count(*) from f1_processed_new.constructor_tb
