...
final_df.write.mode("Overwrite").format("delta").saveAsTable("f1_delta_ingest.driver_tb")

# COMMAND ----------

# MAGIC %sql
# MAGIC desc extended  f1_delta_ingest.driver_tb

# COMMAND ----------

# MAGIC %sql
# MAGIC select file_date,count(*) from f1_delta_ingest.driver_tb
