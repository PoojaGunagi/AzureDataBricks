...
transform_col_df.write.mode("Overwrite").partitionBy('race_year').format("delta").saveAsTable("f1_delta_ingest.race_tb")

# COMMAND ----------

# MAGIC %sql select * from f1_delta_ingest.race_tb

# COMMAND ----------

# MAGIC %sql select file_date, count(race_id) from f1_delta_ingest.race_tb
