...
remove_dupli=final_df.dropDuplicates(['driver_Id','race_Id'])

# COMMAND ----------

remove_dupli.write.mode("overwrite").format("delta").partitionBy("race_id").saveAsTable("f1_delta_ingest.result_tb")

# COMMAND ----------

# MAGIC %sql
# MAGIC select file_date,count(*)
# MAGIC from f1_delta_ingest.result_tb
...
# MAGIC order by driver_id, race_Id desc
